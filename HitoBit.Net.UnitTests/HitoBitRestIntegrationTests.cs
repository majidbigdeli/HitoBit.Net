...
{
    [NonParallelizable]
    internal class HitoBitRestIntegrationTests : RestIntergrationTest<HitoBitRestClient>
    {
        public override bool Run { get; set; } = false;

        public HitoBitRestIntegrationTests()
        {
            HitoBitExchange.RateLimiter.RateLimitTriggered += (x) => Debug.WriteLine(x);
        }

        public override HitoBitRestClient GetClient(ILoggerFactory loggerFactory)
        {
            var key = Environment.GetEnvironmentVariable("APIKEY");
            var sec = Environment.GetEnvironmentVariable("APISECRET");

            Authenticated = key != null && sec != null;
            return new HitoBitRestClient(null, loggerFactory, opts =>
            {
