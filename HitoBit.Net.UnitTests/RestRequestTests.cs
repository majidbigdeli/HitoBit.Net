...
namespace HitoBit.Net.UnitTests
{
    ...
    public class RestRequestTests
    {
        ...
        public async Task ValidateSpotAccountCalls()
        {
            ...
            var tester = new RestRequestValidator<HitoBitRestClient>(client, "Endpoints/Spot/Account", "https://api.hitobit.com", IsAuthenticated, stjCompare: true);
        ...
        public async Task ValidateSpotExchangeDataCalls()
        {
            ...
            var tester = new RestRequestValidator<HitoBitRestClient>(client, "Endpoints/Spot/ExchangeData", "https://api.hitobit.com", IsAuthenticated, stjCompare: true);
            ...
            await tester.ValidateAsync<IHitoBitTick, HitoBit24HPrice>(client => client.SpotApi.ExchangeData.GetTickerAsync("ETHUSDT"), "GetTicker");
        ...
        public async Task ValidateSpotTradingCalls()
        {
            ...
            var tester = new RestRequestValidator<HitoBitRestClient>(client, "Endpoints/Spot/Trading", "https://api.hitobit.com", IsAuthenticated, stjCompare: true);
        ...
        public async Task ValidateUsdFuturesAccountCalls()
        {
            ...
            var tester = new RestRequestValidator<HitoBitRestClient>(client, "Endpoints/UsdFutures/Account", "https://fapi.hitobit.com", IsAuthenticated, stjCompare: true);
        ...
        public async Task ValidateUsdFuturesTradingCalls()
        {
            ...
            var tester = new RestRequestValidator<HitoBitRestClient>(client, "Endpoints/UsdFutures/Trading", "https://fapi.hitobit.com", IsAuthenticated, stjCompare: true);
            ...
            await tester.ValidateAsync(client => client.UsdFuturesApi.Trading.PlaceMultipleOrdersAsync(new[] { new HitoBitFuturesBatchOrder { } }), "PlaceMultipleOrders", skipResponseValidation: true);
            ...
            await tester.ValidateAsync(client => client.UsdFuturesApi.Trading.EditMultipleOrdersAsync(new[] { new HitoBitFuturesBatchEditOrder() }), "EditMultipleOrders", skipResponseValidation: true);
        ...
        public async Task ValidateUsdFuturesTradingAlgoCalls()
        {
            ...
            var tester = new RestRequestValidator<HitoBitRestClient>(client, "Endpoints/UsdFutures/Trading", "https://api.hitobit.com", IsAuthenticated, stjCompare: true);
        ...
        public async Task ValidateCoinFuturesAccountCalls()
        {
            ...
            var tester = new RestRequestValidator<HitoBitRestClient>(client, "Endpoints/CoinFutures/Account", "https://dapi.hitobit.com", IsAuthenticated, stjCompare: true);
        ...
        public async Task ValidateCoinFuturesTradingCalls()
        {
            ...
            var tester = new RestRequestValidator<HitoBitRestClient>(client, "Endpoints/CoinFutures/Trading", "https://dapi.hitobit.com", IsAuthenticated, stjCompare: true);
            ...
            await tester.ValidateAsync(client => client.CoinFuturesApi.Trading.PlaceMultipleOrdersAsync(new[] { new HitoBitFuturesBatchOrder() }), "PlaceMultipleOrders", skipResponseValidation: true);
        ...
        public async Task ValidateGeneralBrokerageCalls()
        {
            ...
            var tester = new RestRequestValidator<HitoBitRestClient>(client, "Endpoints/General/Brokerage", "https://api.hitobit.com", IsAuthenticated, stjCompare: true);
        ...
        public async Task ValidateGeneralCryptoLoansCalls()
        {
            ...
            var tester = new RestRequestValidator<HitoBitRestClient>(client, "Endpoints/General/CryptoLoans", "https://api.hitobit.com", IsAuthenticated, stjCompare: true);
        ...
        public async Task ValidateGeneralAutoInvestCalls()
        {
            ...
            var tester = new RestRequestValidator<HitoBitRestClient>(client, "Endpoints/General/AutoInvest", "https://api.hitobit.com", IsAuthenticated, stjCompare: true);
