# ![.HitoBit.Net](https://raw.githubusercontent.com/majidbigdeli/HitoBit.Net/master/HitoBit.Net/Icon/icon.png) HitoBit.Net  

[![.NET](https://img.shields.io/github/actions/workflow/status/majidbigdeli/HitoBit.Net/dotnet.yml?style=for-the-badge)](https://github.com/majidbigdeli/HitoBit.Net/actions/workflows/dotnet.yml) ![License](https://img.shields.io/github/license/majidbigdeli/HitoBit.Net?style=for-the-badge)

HitoBit.Net is a strongly typed client library for accessing the [HitoBit REST and Websocket API](https://hitobit-docs.github.io/apidocs/#change-log). 
## Features
...
* Extensive logging
* Support for different environments (hitobit.com, hitobit.us, testnet)
...
### NuGet 
[![NuGet version](https://img.shields.io/nuget/v/hitobit.net.svg?style=for-the-badge)](https://www.nuget.org/packages/HitoBit.Net)  [![Nuget downloads](https://img.shields.io/nuget/dt/HitoBit.Net.svg?style=for-the-badge)](https://www.nuget.org/packages/HitoBit.Net)

	dotnet add package HitoBit.Net
	
### GitHub packages
HitoBit.Net is available on [GitHub packages](https://github.com/majidbigdeli/HitoBit.Net/pkgs/nuget/HitoBit.Net). You'll need to add `https://nuget.pkg.github.com/majidbigdeli/index.json` as a NuGet package source.

### Download release
[![GitHub Release](https://img.shields.io/github/v/release/majidbigdeli/HitoBit.Net?style=for-the-badge&label=GitHub)](https://github.com/majidbigdeli/HitoBit.Net/releases)

The NuGet package files are added along side the source with the latest GitHub release which can found [here](https://github.com/majidbigdeli/HitoBit.Net/releases).
...
var restClient = new HitoBitRestClient();
...
<img src="https://github.com/majidbigdeli/HitoBit.Net/blob/f74f262151f21b123deecd9b39a717458a18f6ff/docs/HitoBit.gif" width="600" />

For information on the clients, dependency injection, response processing and more see the [HitoBit.Net documentation](https://majidbigdeli.github.io/HitoBit.Net), [CryptoExchange.Net documentation](https://majidbigdeli.github.io/CryptoExchange.Net), or have a look at the examples [here](https://github.com/majidbigdeli/HitoBit.Net/tree/master/Examples) or [here](https://github.com/majidbigdeli/CryptoExchange.Net/tree/master/Examples).

## CryptoExchange.Net
HitoBit.Net is based on the [CryptoExchange.Net](https://github.com/majidbigdeli/CryptoExchange.Net) base library. Other exchange API implementations based on the CryptoExchange.Net base library are available and follow the same logic.

CryptoExchange.Net also allows for [easy access to different exchange API's](https://majidbigdeli.github.io/CryptoExchange.Net#idocs_shared).

|Exchange|Repository|Nuget|
|--|--|--|
|BingX|[majidbigdeli/BingX.Net](https://github.com/majidbigdeli/BingX.Net)|[![Nuget version](https://img.shields.io/nuget/v/JK.BingX.net.svg?style=flat-square)](https://www.nuget.org/packages/JK.BingX.Net)|
|Bitfinex|[majidbigdeli/Bitfinex.Net](https://github.com/majidbigdeli/Bitfinex.Net)|[![Nuget version](https://img.shields.io/nuget/v/Bitfinex.net.svg?style=flat-square)](https://www.nuget.org/packages/Bitfinex.Net)|
|Bitget|[majidbigdeli/Bitget.Net](https://github.com/majidbigdeli/Bitget.Net)|[![Nuget version](https://img.shields.io/nuget/v/JK.Bitget.net.svg?style=flat-square)](https://www.nuget.org/packages/JK.Bitget.Net)|
|BitMart|[majidbigdeli/BitMart.Net](https://github.com/majidbigdeli/BitMart.Net)|[![Nuget version](https://img.shields.io/nuget/v/BitMart.net.svg?style=flat-square)](https://www.nuget.org/packages/BitMart.Net)|
|Bybit|[majidbigdeli/Bybit.Net](https://github.com/majidbigdeli/Bybit.Net)|[![Nuget version](https://img.shields.io/nuget/v/Bybit.net.svg?style=flat-square)](https://www.nuget.org/packages/Bybit.Net)|
|Coinbase|[majidbigdeli/Coinbase.Net](https://github.com/majidbigdeli/Coinbase.Net)|[![Nuget version](https://img.shields.io/nuget/v/majidbigdeli.Coinbase.Net.svg?style=flat-square)](https://www.nuget.org/packages/majidbigdeli.Coinbase.Net)|
|CoinEx|[majidbigdeli/CoinEx.Net](https://github.com/majidbigdeli/CoinEx.Net)|[![Nuget version](https://img.shields.io/nuget/v/CoinEx.net.svg?style=flat-square)](https://www.nuget.org/packages/CoinEx.Net)|
|CoinGecko|[majidbigdeli/CoinGecko.Net](https://github.com/majidbigdeli/CoinGecko.Net)|[![Nuget version](https://img.shields.io/nuget/v/CoinGecko.net.svg?style=flat-square)](https://www.nuget.org/packages/CoinGecko.Net)|
|Crypto.com|[majidbigdeli/CryptoCom.Net](https://github.com/majidbigdeli/CryptoCom.Net)|[![Nuget version](https://img.shields.io/nuget/v/CryptoCom.net.svg?style=flat-square)](https://www.nuget.org/packages/CryptoCom.Net)|
|Gate.io|[majidbigdeli/GateIo.Net](https://github.com/majidbigdeli/GateIo.Net)|[![Nuget version](https://img.shields.io/nuget/v/GateIo.net.svg?style=flat-square)](https://www.nuget.org/packages/GateIo.Net)|
|HTX|[majidbigdeli/HTX.Net](https://github.com/majidbigdeli/HTX.Net)|[![Nuget version](https://img.shields.io/nuget/v/majidbigdeli.HTX.Net.svg?style=flat-square)](https://www.nuget.org/packages/majidbigdeli.HTX.Net)|
|Kraken|[majidbigdeli/Kraken.Net](https://github.com/majidbigdeli/Kraken.Net)|[![Nuget version](https://img.shields.io/nuget/v/KrakenExchange.net.svg?style=flat-square)](https://www.nuget.org/packages/KrakenExchange.Net)|
|Kucoin|[majidbigdeli/Kucoin.Net](https://github.com/majidbigdeli/Kucoin.Net)|[![Nuget version](https://img.shields.io/nuget/v/Kucoin.net.svg?style=flat-square)](https://www.nuget.org/packages/Kucoin.Net)|
|Mexc|[majidbigdeli/Mexc.Net](https://github.com/majidbigdeli/Mexc.Net)|[![Nuget version](https://img.shields.io/nuget/v/JK.Mexc.net.svg?style=flat-square)](https://www.nuget.org/packages/JK.Mexc.Net)|
|OKX|[majidbigdeli/OKX.Net](https://github.com/majidbigdeli/OKX.Net)|[![Nuget version](https://img.shields.io/nuget/v/JK.OKX.net.svg?style=flat-square)](https://www.nuget.org/packages/JK.OKX.Net)|
|WhiteBit|[majidbigdeli/WhiteBit.Net](https://github.com/majidbigdeli/WhiteBit.Net)|[![Nuget version](https://img.shields.io/nuget/v/WhiteBit.net.svg?style=flat-square)](https://www.nuget.org/packages/WhiteBit.Net)|
...
### Sponsor
Alternatively, sponsor me on Github using [Github Sponsors](https://github.com/sponsors/majidbigdeli). 
...
* Version 10.9.0 - 06 Nov 2024
    * Updated CryptoExchange.Net to version 8.2.0, see https://github.com/majidbigdeli/CryptoExchange.Net/releases/tag/8.2.0
...
* Version 10.8.0 - 28 Oct 2024
    * Updated CryptoExchange.Net to version 8.1.0, see https://github.com/majidbigdeli/CryptoExchange.Net/releases/tag/8.1.0
    * Moved FormatSymbol to HitoBitExchange class
    * Added support Side setting on SharedTrade model
    * Added HitoBitTrackerFactory for creating trackers
    * Added overload to Create method on HitoBitOrderBookFactory support SharedSymbol parameter
...
* Version 10.6.1 - 14 Oct 2024
    * Updated CryptoExchange.Net to version 8.0.3, see https://github.com/majidbigdeli/CryptoExchange.Net/releases/tag/8.0.3
    * Fixed TypeLoadException during initialization

* Version 10.6.0 - 09 Oct 2024
    * Updated CryptoExchange.Net to version 8.0.2, see https://github.com/majidbigdeli/CryptoExchange.Net/releases/tag/8.0.2
    * Added USD-M Futures web socket order API
    * Fixed pagination for shared closed orders USD futures

* Version 10.5.0 - 27 Sep 2024
    * Updated CryptoExchange.Net to version 8.0.0, see https://github.com/majidbigdeli/CryptoExchange.Net/releases/tag/8.0.0
    * Added Shared client interfaces implementation for Spot, USD-M Futures, Coin-M Futures Rest and Socket clients
    * Updated Id property from `string?` to `string` on HitoBitWithdrawalPlaced model
...
* Version 10.3.0 - 28 Aug 2024
    * Updated CryptoExchange.Net to version 7.11.2, see https://github.com/majidbigdeli/CryptoExchange.Net/releases/tag/7.11.2
...
* Version 10.1.0 - 07 Aug 2024
    * Updated CryptoExchange.Net to version 7.11.0, see https://github.com/majidbigdeli/CryptoExchange.Net/releases/tag/7.11.0
    * Updated XML code comments
    * Fixed HitoBitFuturesAccountAsset MaintMargin deserialization
    * Fixed HitoBitPosition MaintMargin deserialization
    * Fixed HitoBitPosition UnrealizedProfit deserialization for Coin-M futures
...
* Version 10.0.0 - 27 Jul 2024
    * Updated CryptoExchange.Net to version 7.10.0, see https://github.com/majidbigdeli/CryptoExchange.Net/releases/tag/7.10.0
...
* Version 9.12.0 - 16 Jul 2024
    * Updated CryptoExchange.Net to version 7.9.0, see https://github.com/majidbigdeli/CryptoExchange.Net/releases/tag/7.9.0
...
* Version 9.11.0 - 23 Jun 2024
    * Updated CryptoExchange.Net to version 7.7.0, see https://github.com/majidbigdeli/CryptoExchange.Net/releases/tag/7.7.0
    * Added dedicated connection configuration; a websocket connection can now be established before making the first request by calling `hitobitSocketClient.SpotApi.PrepareConnectionsAsync();`
...
* Version 9.10.0 - 11 Jun 2024
    ...
    * Updated CryptoExchange.Net to v7.6.0, see https://github.com/majidbigdeli/CryptoExchange.Net?tab=readme-ov-file#release-notes for release notes
...
* Version 9.9.7 - 07 May 2024
    * Updated CryptoExchange.Net to v7.5.2, see https://github.com/majidbigdeli/CryptoExchange.Net?tab=readme-ov-file#release-notes for release notes
...
* Version 9.9.5 - 01 May 2024
    ...
    * Updated CryptoExchange.Net to v7.5.0, see https://github.com/majidbigdeli/CryptoExchange.Net?tab=readme-ov-file#release-notes for release notes

* Version 9.9.4 - 28 Apr 2024
    * Added SpotApi.Account.GetWithdrawalAddressesAsync endpoint
    * Added Url and ApiDocsUrl to HitoBitExchange static class
    * Added HitoBitOrderBookFactory book creation method
    * Fixed HitoBitOrderBookFactory injection issue
    * Updated CryptoExchange.Net to v7.4.0, see https://github.com/majidbigdeli/CryptoExchange.Net?tab=readme-ov-file#release-notes for release notes
...
* Version 9.9.3 - 23 Apr 2024
    ...
    * Updated CryptoExchange.Net to 7.3.3, see https://github.com/majidbigdeli/CryptoExchange.Net?tab=readme-ov-file#release-notes for release notes
...
* Version 9.9.0 - 18 Apr 2024
    * Updated CryptoExchange.Net to 7.3.1, see https://github.com/majidbigdeli/CryptoExchange.Net?tab=readme-ov-file#release-notes for release notes
...
* Version 9.7.1 - 24 Mar 2024
	* Updated CryptoExchange.Net to 7.2.0, see https://github.com/majidbigdeli/CryptoExchange.Net?tab=readme-ov-file#release-notes for release notes

* Version 9.7.0 - 16 Mar 2024
    * Updated CryptoExchange.Net to 7.1.0, see https://github.com/majidbigdeli/CryptoExchange.Net?tab=readme-ov-file#release-notes for release notes
...
* Version 9.5.0 - 25 Feb 2024
    * Updated CryptoExchange.Net and implemented reworked websocket message handling. For release notes for the CryptoExchange.Net base library see: https://github.com/majidbigdeli/CryptoExchange.Net?tab=readme-ov-file#release-notes
    * Fixed issue in DI registration causing http client to not be correctly injected
    * Removed redundant HitoBitRestClient constructor overload
...
* Version 9.0.0 - 25 Jun 2023
    ...
    * Renamed HitoBitClient to HitoBitRestClient
    * Renamed UsdFuturesStreams and CoinFuturesStreams to UsdFuturesApi and CoinFuturesApi on the HitoBitSocketClient
    * Updated endpoints to consistently use a base url without any path as basis to make switching environments/base urls clearer
    * Removed HitoBitApiCredentials as the base ApiCredentials now supports RSA signing
    * Added IHitoBitOrderBookFactory and implementation for creating order books
    * Updated dependency injection register method (AddHitoBit)
...
* Version 8.6.2 - 22 May 2023
    ...
    * Fixed missing writers for HitoBitSymbolFilter serialization
...
* Version 8.3.0 - 17 Nov 2022
    * Updated CryptoExchange.Net
    * Fixed HitoBitConvertTransferRecord DeductedQuantity property
...
* Version 8.1.9 - 24 Aug 2022
    ...
    * Added new Notional filter for HitoBitSymbols
...
* Version 8.1.8 - 13 Aug 2022
    ...
    * Fixed HitoBitRebate quantity deserialization
...
* Version 8.0.13 - 08 May 2022
    * Added TierAnnualInterestRate to HitoBitFlexibleProductPosition
...
* Version 8.0.7 - 08 Mar 2022
    * Fixed inconsistent naming in HitoBitLendingAccount model
    * Added AllowTrailingStop property on HitoBitSymbol
...
* Version 8.0.0 - 18 Feb 2022
	* Added Github.io page for documentation: https://majidbigdeli.github.io/HitoBit.Net/
	* Added unit tests for parsing the returned JSON for each endpoint and subscription
	* Added AddHitoBit extension method on IServiceCollection for easy dependency injection
	...
	* Updated CryptoExchange.Net, see https://github.com/majidbigdeli/CryptoExchange.Net#release-notes
	* See https://majidbigdeli.github.io/HitoBit.Net/MigrationGuide.html for additional notes for updating from V7 to V8
...
* Version 7.0.0 - 12 Aug 2021
	* Release version with new CryptoExchange.Net version 4.0.0
		* Multiple changes regarding logging and socket connection, see [CryptoExchange.Net release notes](https://github.com/majidbigdeli/CryptoExchange.Net#release-notes)
...
* Version 6.14.0-beta5 - 07 Jun 2021
    * Added HitoBitApiAddresses class containing different api setups for easier
    * Updated CryptoExchange.Net
...
* Version 6.10.0 - 22 feb 2021
    * IndexPrice added to HitoBitFurustMarkPrice
...
* Version 6.3.3 - 09 nov 2020
    * Updated check for valid HitoBit symbol
...
* Version 6.0.0-beta.1 - 12 Aug 2020
    * Restructured HitoBitClient and HitoBitSocketClient to include the futures and brokerage API. Clients are now divided per topic
...
* Version 5.1.3 - 02 Jun 2020
    ...
    * Added HitoBitFuturesSymbolOrderBook
...
* Version 5.0.4 - 10 Dec 2019
    * Fix for HitoBitSymbolOrderBook
...
* Version 4.3.3 - 06 Oct 2019
    * Added serialization method for HitoBitSymbolFilter
...
* Version 4.0.12 - 09 apr 2019
	...
	* Added update time to HitoBitStreamAccountInfo
	* Added IsSpotTradingAllowed and IsMarginTradingAllowed fields to HitoBitSymbol
	* Added IDisposable to client interfaces

* Version 4.0.11 - 02 apr 2019
	* Added Symbol field in HitoBitTrade
...
* Version 3.3.0 - 15 nov 2018
	* Updated to support latest HitoBit API update, including:
...
* Version 3.2.12 - 15 nov 2018
	* Added event time to HitoBitStreamTick
...
* Version 2.3.2 - 09 feb 2018
	* Changed base address from https://www.hitobit.com to https://api.hitobit.com to fix connection errors
...
* Version 2.2.5 - 24 jan 2018
	...
	* Added `HitoBitHelpers` static class containing some basic helper functions
...
* Version 2.2.4 - 23 jan 2018
	...
	* Split the HitoBitSymbolFilter in 3 classes
...
* Version 2.1.3 - 9 nov 2017
	...
	* Renamed ApiResult to HitoBitApiResult
...
* Version 2.1.0 - 30 okt 2017
	* Small rename/refactor, HitoBitSocketClient also use ApiResult now

* Version 2.0.1 - 30 okt 2017
	* Improved error messages/handling in HitoBitClient
...
* Version 2.0.0 - 25 okt 2017
	...
	* Split websocket and restapi functionality in HitoBitClient and HitoBitSocketClient
...
* Version 1.1.0 - 20 okt 2017 
	...
	* Cleaned up HitoBitClient a bit
