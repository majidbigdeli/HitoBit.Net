namespace HitoBit.Net.Objects.Models.Spot.Mining
{
    ...
    /// Resale list
    /// </summary>
    public record HitoBitHashrateResaleDetails
    {
        /// <summary>
        ...
        public IEnumerable<HitoBitHashrateResaleDetailsItem> ProfitTransferDetails { get; set; } = Array.Empty<HitoBitHashrateResaleDetailsItem>();
    }

    /// <summary>
    /// Resale item
    /// </summary>
    public record HitoBitHashrateResaleDetailsItem
    {
        /// <summary>
        /// Config id
        /// </summary>
