...
namespace HitoBit.Net.Objects.Models.Spot.Brokerage.SubAccountData
{
    ...
    /// </summary>
    public class HitoBitBrokerageTransferFuturesTransactions
    {
        /// <summary>
        /// Success
        /// </summary>
        ...
        /// Futures type
        /// </summary>
        public HitoBitBrokerageFuturesType FuturesType { get; set; }
    ...
    /// </summary>
    public class HitoBitBrokerageTransferFuturesTransaction
    {
        /// <summary>
        /// From Id
        /// </summary>
