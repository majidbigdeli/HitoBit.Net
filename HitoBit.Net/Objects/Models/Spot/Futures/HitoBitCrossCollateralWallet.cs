...
namespace HitoBit.Net.Objects.Models.Spot.Futures
{
    ...
    /// </summary>
    public class HitoBitCrossCollateralWallet
    {
        /// <summary>
        ...
        /// Cross collaterals
        /// </summary>
        public IEnumerable<HitoBitCrossCollateralWalletEntry> CrossCollaterals { get; set; } = Array.Empty<HitoBitCrossCollateralWalletEntry>();
    }

    /// <summary>
    /// Cross collateral data
    /// </summary>
    public class HitoBitCrossCollateralWalletEntry
    {
        /// <summary>
        /// Loan asset
        /// </summary>
