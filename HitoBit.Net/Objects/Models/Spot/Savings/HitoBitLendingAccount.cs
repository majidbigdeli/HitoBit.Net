...
namespace HitoBit.Net.Objects.Models.Spot.Lending
{
    ...
    /// Lending account
    /// </summary>
    public class HitoBitLendingAccount
    {
        /// <summary>
        ...
        public IEnumerable<HitoBitLendingPositionAmount> PositionAmounts { get; set; } = Array.Empty<HitoBitLendingPositionAmount>();
    }

    /// <summary>
    /// Lending position amount
    /// </summary>
    public class HitoBitLendingPositionAmount
    {
        /// <summary>
        /// Amount of the asset
        /// </summary>
