...
namespace HitoBit.Net.Objects.Models.Spot
{
    ...
    /// Stream order book
    /// </summary>
    public class HitoBitEventOrderBook: HitoBitOrderBook, IHitoBitEventOrderBook
    {
        /// <summary>
        ...
        /// </summary>
        [JsonProperty("b")]
        internal IEnumerable<HitoBitOrderBookEntry> BidsStream { set => Bids = value; }

        /// <summary>
        /// Setter for asks (needed forJson.Net)
        /// </summary>
        [JsonProperty("a")]
        internal IEnumerable<HitoBitOrderBookEntry> AsksStream { set => Asks = value; }
    }
}
