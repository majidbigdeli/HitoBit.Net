...
namespace HitoBit.Net.Objects.Models.Spot.AutoInvest
{
    ...
    /// Invest plan info
    /// </summary>
    public record HitoBitAutoInvestPlan
    {
        /// <summary>
        /// Plan value in USD
        /// </summary>
        ...
        public IEnumerable<HitoBitAutoInvestPlanDetails> Plans { get; set; } = Array.Empty<HitoBitAutoInvestPlanDetails>();
    }

    /// <summary>
    /// Plan info
    /// </summary>
    public record HitoBitAutoInvestPlanDetails
    {
        /// <summary>
        /// Plan id
        /// </summary>
