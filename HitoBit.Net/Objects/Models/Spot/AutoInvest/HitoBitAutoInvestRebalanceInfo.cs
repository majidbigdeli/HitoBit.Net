...
namespace HitoBit.Net.Objects.Models.Spot.AutoInvest
{
    ...
    /// Rebalance info
    /// </summary>
    public record HitoBitAutoInvestRebalanceInfo
    {
        /// <summary>
        /// Index id
        /// </summary>
        ...
        public IEnumerable<HitoBitAutoInvestRebalanceDetails> TransactionDetails { get; set; } = Array.Empty<HitoBitAutoInvestRebalanceDetails>();
    }

    /// <summary>
    /// 
    /// </summary>
    public record HitoBitAutoInvestRebalanceDetails
    {
        /// <summary>
        /// Asset
        /// </summary>
