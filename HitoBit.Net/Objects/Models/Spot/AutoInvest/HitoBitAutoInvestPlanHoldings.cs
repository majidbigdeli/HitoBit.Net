...
namespace HitoBit.Net.Objects.Models.Spot.AutoInvest
{
    ...
    /// Plan holdings
    /// </summary>
    public record HitoBitAutoInvestPlanHoldings
    {
        /// <summary>
        /// Plan id
        /// </summary>
        ...
        public IEnumerable<HitoBitAutoInvestPlanHoldingDetails> Details { get; set; } = Array.Empty<HitoBitAutoInvestPlanHoldingDetails>();
    }

    /// <summary>
    /// Holding details
    /// </summary>
    public record HitoBitAutoInvestPlanHoldingDetails
    {
        /// <summary>
        /// Target asset
        /// </summary>
