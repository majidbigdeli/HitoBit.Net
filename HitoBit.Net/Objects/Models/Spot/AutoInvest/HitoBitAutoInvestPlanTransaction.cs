...
namespace HitoBit.Net.Objects.Models.Spot.AutoInvest
{
    ...
    /// Transactions
    /// </summary>
    public record HitoBitAutoInvestPlanTransactions
    {
        /// <summary>
        /// Total
        /// </summary>
        ...
        public IEnumerable<HitoBitAutoInvestPlanTransaction> List { get; set; } = Array.Empty<HitoBitAutoInvestPlanTransaction>();
    }

    /// <summary>
    /// Plan transaction info
    /// </summary>
    public record HitoBitAutoInvestPlanTransaction
    {
        /// <summary>
        /// Id
        /// </summary>
