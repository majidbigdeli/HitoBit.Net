namespace HitoBit.Net.Objects.Models.Spot.Margin
{
    ...
    /// </summary>
    public record HitoBitMarginAccount
    {
        /// <summary>
        ...
        public IEnumerable<HitoBitMarginBalance> Balances { get; set; } = Array.Empty<HitoBitMarginBalance>();
    }

    /// <summary>
    /// Information about an asset balance
    /// </summary>
    public record HitoBitMarginBalance
    {
        /// <summary>
