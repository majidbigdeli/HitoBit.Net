namespace HitoBit.Net.Objects.Models.Spot.Margin
{
    ...
    /// </summary>
    public record HitoBitMarginDustAsset
    {
        /// <summary>
        /// Total btc
        /// </summary>
        ...
        public IEnumerable<HitoBitMarginDustAssetDetails> Details { get; set; } = Array.Empty<HitoBitMarginDustAssetDetails>();
    }

    /// <summary>
    /// Asset dust details
    /// </summary>
    public record HitoBitMarginDustAssetDetails
    {
        /// <summary>
        /// Asset
        /// </summary>
