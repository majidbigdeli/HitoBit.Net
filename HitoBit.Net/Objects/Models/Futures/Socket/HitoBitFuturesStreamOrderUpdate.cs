...
namespace HitoBit.Net.Objects.Models.Futures.Socket
{
    ...
    /// Order update
    /// </summary>
    public record HitoBitFuturesStreamOrderUpdate: HitoBitStreamEvent
    {
        /// <summary>
        /// Update data
        /// </summary>
        [JsonPropertyName("o")]
        public HitoBitFuturesStreamOrderUpdateData UpdateData { get; set; } = new HitoBitFuturesStreamOrderUpdateData();
    ...
    /// </summary>
    public record HitoBitFuturesStreamOrderUpdateData
    {
        /// <summary>
