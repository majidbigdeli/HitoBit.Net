...
namespace HitoBit.Net.Objects.Models.Futures.Socket
{
    ...
    /// </summary>
    public record HitoBitFuturesStreamCoinKlineData : HitoBitStreamEvent, IHitoBitStreamKlineData
    {
        /// <summary>
        ...
        /// </summary>
        [JsonPropertyName("k")]
        [JsonConverter(typeof(InterfaceConverter<HitoBitFuturesStreamCoinKline, IHitoBitStreamKline>))]
    ...
    /// The kline data
    /// </summary>
    public record HitoBitFuturesStreamCoinKline : HitoBitKlineBase, IHitoBitStreamKline
    {
        /// <summary>
