...
namespace HitoBit.Net.Objects.Models.Futures.AlgoOrders
{
    ...
    /// Sub order list
    /// </summary>
    public record HitoBitAlgoSubOrderList
    {
        /// <summary>
        ...
        public IEnumerable<HitoBitAlgoSubOrder> SubOrders { get; set; } = Array.Empty<HitoBitAlgoSubOrder>();
    }

    /// <summary>
    /// Algo sub order info
    /// </summary>
    public record HitoBitAlgoSubOrder
    {
        /// <summary>
        /// Algo id
        /// </summary>
