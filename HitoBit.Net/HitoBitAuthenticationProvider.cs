...
{
    internal class HitoBitAuthenticationProvider : AuthenticationProvider
    {
        public HitoBitAuthenticationProvider(HitoBitApiCredentials credentials) : base(credentials)
        {
        }
        ...
        public override void AuthenticateRequest(RestApiClient apiClient, Uri uri, HttpMethod method, Dictionary<string, object> providedParameters, bool auth, ArrayParametersSerialization arraySerialization, HttpMethodParameterPosition parameterPosition, out SortedDictionary<string, object> uriParameters, out SortedDictionary<string, object> bodyParameters, out Dictionary<string, string> headers)
        {
            ...
            var authType = ((HitoBitApiCredentials)Credentials).Type;
