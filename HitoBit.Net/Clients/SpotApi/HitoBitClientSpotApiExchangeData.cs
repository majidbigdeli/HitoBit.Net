...
{
    /// <inheritdoc />
    public class HitoBitClientSpotApiExchangeData : IHitoBitClientSpotApiExchangeData
    {
        ...
        internal HitoBitClientSpotApiExchangeData(Log log, HitoBitClientSpotApi baseClient)
        {
            _log = log;
