...
{
    /// <inheritdoc cref="IHitoBitClientSpotApi" />
    public class HitoBitClientSpotApi : RestApiClient, IHitoBitClientSpotApi, ISpotClient
    {
        #region fields 
        internal new readonly HitoBitClientOptions Options;

        internal HitoBitExchangeInfo? ExchangeInfo;
        ...
        internal HitoBitClientSpotApi(Log log, HitoBitClientOptions options) : base(log, options, options.SpotApiOptions)
        {
            Options = options;
            _log = log;

            Account = new HitoBitClientSpotApiAccount(this);
            ExchangeData = new HitoBitClientSpotApiExchangeData(log, this);
            Trading = new HitoBitClientSpotApiTrading(log, this);
        ...
        internal async Task<WebCallResult<HitoBitPlacedOrder>> PlaceOrderInternal(Uri uri,
            string symbol,
            ...
            CancellationToken ct = default)
        {
            ...
            if (!rulesCheck.Passed)
            {
                ...
                return new WebCallResult<HitoBitPlacedOrder>(new ArgumentError(rulesCheck.ErrorMessage!));
            }
        ...
        internal async Task<HitoBitTradeRuleResult> CheckTradeRules(string symbol, decimal? quantity, decimal? quoteQuantity, decimal? price, decimal? stopPrice, SpotOrderType? type, CancellationToken ct)
        {
        ...
        async Task<WebCallResult<Order>> IBaseRestClient.GetOrderAsync(string orderId, string? symbol, CancellationToken ct)
        {
            ...
            if (string.IsNullOrWhiteSpace(symbol))
                throw new ArgumentException(nameof(symbol) + " required for HitoBit " + nameof(ISpotClient.GetOrderAsync), nameof(symbol));
        ...
        async Task<WebCallResult<IEnumerable<UserTrade>>> IBaseRestClient.GetOrderTradesAsync(string orderId, string? symbol, CancellationToken ct)
        {
            ...
            if (string.IsNullOrWhiteSpace(symbol))
                throw new ArgumentException(nameof(symbol) + " required for HitoBit " + nameof(ISpotClient.GetOrderTradesAsync), nameof(symbol));
        ...
        {
            if (string.IsNullOrWhiteSpace(symbol))
                throw new ArgumentException(nameof(symbol) + " required for HitoBit " + nameof(ISpotClient.GetClosedOrdersAsync), nameof(symbol));
        ...
        async Task<WebCallResult<OrderId>> IBaseRestClient.CancelOrderAsync(string orderId, string? symbol, CancellationToken ct)
        {
            ...
            if (string.IsNullOrWhiteSpace(symbol))
                throw new ArgumentException(nameof(symbol) + " required for HitoBit " + nameof(ISpotClient.CancelOrderAsync), nameof(symbol));
        ...
        {
            if (string.IsNullOrWhiteSpace(symbol))
                throw new ArgumentException(nameof(symbol) + " required for HitoBit " + nameof(ISpotClient.GetTickerAsync), nameof(symbol));
        ...
        {
            if (string.IsNullOrWhiteSpace(symbol))
                throw new ArgumentException(nameof(symbol) + " required for HitoBit " + nameof(ISpotClient.GetKlinesAsync), nameof(symbol));
        ...
        {
            if (string.IsNullOrWhiteSpace(symbol))
                throw new ArgumentException(nameof(symbol) + " required for HitoBit " + nameof(ISpotClient.GetOrderBookAsync), nameof(symbol));
        ...
        {
            if (string.IsNullOrWhiteSpace(symbol))
                throw new ArgumentException(nameof(symbol) + " required for HitoBit " + nameof(ISpotClient.GetRecentTradesAsync), nameof(symbol));
