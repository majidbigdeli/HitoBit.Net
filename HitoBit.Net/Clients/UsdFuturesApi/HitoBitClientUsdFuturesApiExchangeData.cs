...
{
    /// <inheritdoc />
    public class HitoBitClientUsdFuturesApiExchangeData : IHitoBitClientUsdFuturesApiExchangeData
    {
        ...
        internal HitoBitClientUsdFuturesApiExchangeData(Log log, HitoBitClientUsdFuturesApi baseClient)
        {
            _log = log;
