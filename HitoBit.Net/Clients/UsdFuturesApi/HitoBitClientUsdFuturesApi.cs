...
{
    /// <inheritdoc cref="IHitoBitClientUsdFuturesApi" />
    public class HitoBitClientUsdFuturesApi : RestApiClient, IHitoBitClientUsdFuturesApi, IFuturesClient
    {
        #region fields 
        internal new readonly HitoBitClientOptions Options;

        internal HitoBitFuturesUsdtExchangeInfo? ExchangeInfo;
        ...
        internal HitoBitClientUsdFuturesApi(Log log, HitoBitClientOptions options) :
            base(log,options, options.UsdFuturesApiOptions)
        {
            Options = options;

            Account = new HitoBitClientUsdFuturesApiAccount(this);
            ExchangeData = new HitoBitClientUsdFuturesApiExchangeData(log, this);
            Trading = new HitoBitClientUsdFuturesApiTrading(log, this);
