...
{
    /// <inheritdoc />
    public class HitoBitClientCoinFuturesApiTrading : IHitoBitClientCoinFuturesApiTrading
    {
        ...
        internal HitoBitClientCoinFuturesApiTrading(Log log, HitoBitClientCoinFuturesApi baseClient)
        {
            _log = log;
        ...
        public async Task<WebCallResult<IEnumerable<HitoBitFuturesOrder>>> GetOpenOrdersAsync(string? symbol = null, int? receiveWindow = null, CancellationToken ct = default)
        {
            ...
            return await _baseClient.SendRequestInternal<IEnumerable<HitoBitFuturesOrder>>(_baseClient.GetUrl(openOrdersEndpoint, api, "1"), HttpMethod.Get, ct, parameters, true, weight: symbol == null ? 5 : 1).ConfigureAwait(false);
        }
        ...
        public async Task<WebCallResult<IEnumerable<HitoBitFuturesOrder>>> GetOrdersAsync(string? symbol, long? orderId = null, DateTime? startTime = null, DateTime? endTime = null, int? limit = null, int? receiveWindow = null, CancellationToken ct = default)
        {
            ...
            return await _baseClient.SendRequestInternal<IEnumerable<HitoBitFuturesOrder>>(_baseClient.GetUrl(allOrdersEndpoint, api, "1"), HttpMethod.Get, ct, parameters, true, weight: symbol == null ? 20 : 40).ConfigureAwait(false);
        }
        ...
        /// <inheritdoc />
        public async Task<WebCallResult<IEnumerable<HitoBitFuturesCoinTrade>>> GetUserTradesAsync(string? symbol = null, string? pair = null, DateTime? startTime = null, DateTime? endTime = null, int? limit = null, long? fromId = null, long? receiveWindow = null, CancellationToken ct = default)
        {
            limit?.ValidateIntBetween(nameof(limit), 1, 1000);
            ...
            return await _baseClient.SendRequestInternal<IEnumerable<HitoBitFuturesCoinTrade>>(_baseClient.GetUrl(myFuturesTradesEndpoint, api, "1"), HttpMethod.Get, ct, parameters, true, weight: symbol == null ? 40 : 20).ConfigureAwait(false);
        }
