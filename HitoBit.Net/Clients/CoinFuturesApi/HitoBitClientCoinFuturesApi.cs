...
{
    /// <inheritdoc cref="IHitoBitClientCoinFuturesApi" />
    public class HitoBitClientCoinFuturesApi : RestApiClient, IHitoBitClientCoinFuturesApi, IFuturesClient
    {
        #region fields 
        internal new readonly HitoBitClientOptions Options;

        internal HitoBitFuturesCoinExchangeInfo? ExchangeInfo;
        ...
        internal HitoBitClientCoinFuturesApi(Log log, HitoBitClientOptions options) :
            base(log, options, options.CoinFuturesApiOptions)
        {
            Options = options;

            Account = new HitoBitClientCoinFuturesApiAccount(this);
            ExchangeData = new HitoBitClientCoinFuturesApiExchangeData(log, this);
            Trading = new HitoBitClientCoinFuturesApiTrading(log, this);
