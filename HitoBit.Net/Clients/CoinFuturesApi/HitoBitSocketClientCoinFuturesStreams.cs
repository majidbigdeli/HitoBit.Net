...
{
    /// <inheritdoc cref="IHitoBitSocketClientCoinFuturesStreams" />
    public class HitoBitSocketClientCoinFuturesStreams : SocketApiClient, IHitoBitSocketClientCoinFuturesStreams
    {
        #region fields
        ...
        internal HitoBitSocketClientCoinFuturesStreams(Log log, HitoBitSocketClientOptions options) :
        ...
        /// <inheritdoc />
        public async Task<CallResult<UpdateSubscription>> SubscribeToAllBookTickerUpdatesAsync(Action<DataEvent<HitoBitStreamBookPrice>> onMessage, CancellationToken ct = default)
        {
