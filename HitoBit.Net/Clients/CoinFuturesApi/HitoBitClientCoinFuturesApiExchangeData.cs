...
{
    /// <inheritdoc />
    public class HitoBitClientCoinFuturesApiExchangeData : IHitoBitClientCoinFuturesApiExchangeData
    {
        ...
        internal HitoBitClientCoinFuturesApiExchangeData(Log log, HitoBitClientCoinFuturesApi baseClient)
        {
            _log = log;
