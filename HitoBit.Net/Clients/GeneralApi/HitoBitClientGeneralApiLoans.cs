...
{
    /// <inheritdoc />
    public class HitoBitClientGeneralApiCryptoLoans : IHitoBitClientGeneralApiCryptoLoans
    {
        // Crypto loans
        ...
        internal HitoBitClientGeneralApiCryptoLoans(HitoBitClientGeneralApi baseClient)
        {
