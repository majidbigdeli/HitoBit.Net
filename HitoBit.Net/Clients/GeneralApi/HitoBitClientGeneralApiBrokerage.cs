...
{
    /// <inheritdoc />
    public class HitoBitClientGeneralApiBrokerage : IHitoBitClientGeneralApiBrokerage
    {
        ...
        internal HitoBitClientGeneralApiBrokerage(HitoBitClientGeneralApi baseClient)
        {
