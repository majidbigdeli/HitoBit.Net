...
namespace HitoBit.Net.Interfaces.Clients.SpotApi
{
    ...
    public interface IHitoBitRestClientSpotApiExchangeData
    {
        ...
        Task<WebCallResult<HitoBitExchangeInfo>> GetExchangeInfoAsync(CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>Exchange info</returns>
        Task<WebCallResult<HitoBitExchangeInfo>> GetExchangeInfoAsync(string symbol, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>Exchange info</returns>
        Task<WebCallResult<HitoBitExchangeInfo>> GetExchangeInfoAsync(IEnumerable<string> symbols, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>Exchange info</returns>
        Task<WebCallResult<HitoBitExchangeInfo>> GetExchangeInfoAsync(AccountType permission, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>Exchange info</returns>
        Task<WebCallResult<HitoBitExchangeInfo>> GetExchangeInfoAsync(AccountType[] permissions, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>List of book prices</returns>
        Task<WebCallResult<IEnumerable<HitoBitBookPrice>>> GetBookPricesAsync(IEnumerable<string> symbol, CancellationToken ct = default);
        ...
        Task<WebCallResult<HitoBitMarginAsset>> GetMarginAssetAsync(string asset, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>List of margin assets</returns>
        Task<WebCallResult<HitoBitMarginPair>> GetMarginSymbolAsync(string symbol, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>List of margin assets</returns>
        Task<WebCallResult<IEnumerable<HitoBitMarginAsset>>> GetMarginAssetsAsync(CancellationToken ct = default);
        ...
        Task<WebCallResult<IEnumerable<HitoBitMarginPair>>> GetMarginSymbolsAsync(CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<HitoBitIsolatedMarginSymbol>> GetIsolatedMarginSymbolAsync(string symbol,
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<IEnumerable<HitoBitIsolatedMarginSymbol>>> GetIsolatedMarginSymbolsAsync(int? receiveWindow = null, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<IEnumerable<HitoBitBSwapPool>>> GetLiquidityPoolsAsync(int? receiveWindow = null, CancellationToken ct = default);
