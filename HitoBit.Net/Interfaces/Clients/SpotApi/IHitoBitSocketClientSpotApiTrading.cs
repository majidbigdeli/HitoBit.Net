...
namespace HitoBit.Net.Interfaces.Clients.SpotApi
{
    ...
    /// </summary>
    public interface IHitoBitSocketClientSpotApiTrading
    {
        /// <summary>
        ...
        /// <returns></returns>
        Task<CallResult<HitoBitResponse<IEnumerable<HitoBitOrder>>>> CancelAllOrdersAsync(string symbol, CancellationToken ct = default);
        /// <summary>
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<CallResult<HitoBitResponse<HitoBitOrderOcoList>>> CancelOcoOrderAsync(string symbol, long? orderId = null, string? clientOrderId = null, string? newClientOrderId = null, CancellationToken ct = default);
        /// <summary>
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<CallResult<HitoBitResponse<HitoBitOrder>>> CancelOrderAsync(string symbol, long? orderId = null, string? clientOrderId = null, string? newClientOrderId = null, CancellationToken ct = default);
        /// <summary>
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<CallResult<HitoBitResponse<HitoBitOrderOcoList>>> GetOcoOrderAsync(long? orderId = null, string? clientOrderId = null, CancellationToken ct = default);
        /// <summary>
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<CallResult<HitoBitResponse<IEnumerable<HitoBitOrderOcoList>>>> GetOcoOrdersAsync(long? fromOrderId = null, DateTime? startTime = null, DateTime? endTime = null, int? limit = null, CancellationToken ct = default);
        /// <summary>
        /// Get open Oco orders
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<CallResult<HitoBitResponse<IEnumerable<HitoBitOrderOcoList>>>> GetOpenOcoOrdersAsync(CancellationToken ct = default);
        /// <summary>
        /// Get open orders
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<CallResult<HitoBitResponse<IEnumerable<HitoBitOrder>>>> GetOpenOrdersAsync(string? symbol = null, CancellationToken ct = default);
        /// <summary>
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<CallResult<HitoBitResponse<HitoBitOrder>>> GetOrderAsync(string symbol, long? orderId = null, string? clientOrderId = null, CancellationToken ct = default);
        /// <summary>
        /// Get order history
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<CallResult<HitoBitResponse<IEnumerable<HitoBitOrder>>>> GetOrdersAsync(string symbol, long? fromOrderId = null, DateTime? startTime = null, DateTime? endTime = null, int? limit = null, CancellationToken ct = default);
        /// <summary>
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<CallResult<HitoBitResponse<IEnumerable<HitoBitPreventedTrade>>>> GetPreventedTradesAsync(string symbol, long? preventedTradeId = null, long? orderId = null, long? fromPreventedTradeId = null, int? limit = null, CancellationToken ct = default);
        /// <summary>
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<CallResult<HitoBitResponse<IEnumerable<HitoBitTrade>>>> GetUserTradesAsync(string symbol, long? orderId = null, long? fromOrderId = null, DateTime? startTime = null, DateTime? endTime = null, int? limit = null, CancellationToken ct = default);
        ...
        Task<CallResult<HitoBitResponse<HitoBitOrderOcoList>>> PlaceOcoOrderAsync(string symbol, OrderSide side, decimal quantity, decimal price, decimal stopPrice, decimal? stopLimitPrice = null, string? listClientOrderId = null, string? limitClientOrderId = null, string? stopClientOrderId = null, decimal? limitIcebergQuantity = null, decimal? stopIcebergQuantity = null, TimeInForce? stopLimitTimeInForce = null, int? trailingDelta = null, int? limitStrategyId = null, int? limitStrategyType = null, decimal? limitIcebergQty = null, int? stopStrategyId = null, int? stopStrategyType = null, int? stopIcebergQty = null, SelfTradePreventionMode? selfTradePreventionMode = null, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<CallResult<HitoBitResponse<HitoBitOrderOcoList>>> PlaceOcoOrderListAsync(
            string symbol,
            OrderSide side,
            decimal quantity,
        ...
        Task<CallResult<HitoBitResponse<HitoBitPlacedOrder>>> PlaceOrderAsync(string symbol, OrderSide side, SpotOrderType type, decimal? quantity = null, decimal? quoteQuantity = null, string? newClientOrderId = null, decimal? price = null, TimeInForce? timeInForce = null, decimal? stopPrice = null, decimal? icebergQty = null, int? trailingDelta = null, int? strategyId = null, int? strategyType = null, SelfTradePreventionMode? selfTradePreventionMode = null, CancellationToken ct = default);
        ...
        Task<CallResult<HitoBitResponse<HitoBitPlacedOrder>>> PlaceTestOrderAsync(string symbol, OrderSide side, SpotOrderType type, decimal? quantity = null, decimal? quoteQuantity = null, string? newClientOrderId = null, decimal? price = null, TimeInForce? timeInForce = null, decimal? stopPrice = null, decimal? icebergQty = null, int? trailingDelta = null, int? strategyId = null, int? strategyType = null, SelfTradePreventionMode? selfTradePreventionMode = null, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<CallResult<HitoBitResponse<HitoBitReplaceOrderResult>>> ReplaceOrderAsync(string symbol, OrderSide side, SpotOrderType type, CancelReplaceMode cancelReplaceMode, long? cancelOrderId = null, string? cancelClientOrderId = null, string? newCancelClientOrderId = null, string? newClientOrderId = null, decimal? quantity = null, decimal? quoteQuantity = null, decimal? price = null, TimeInForce? timeInForce = null, decimal? stopPrice = null, decimal? icebergQty = null, OrderResponseType? orderResponseType = null, int? trailingDelta = null, int? strategyId = null, int? strategyType = null, CancellationToken ct = default);
    }
}
