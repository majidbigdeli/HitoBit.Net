...
namespace HitoBit.Net.Interfaces.Clients.SpotApi
{
    ...
    public interface IHitoBitSocketClientSpotApiTrading
    {
        ...
        /// <returns></returns>
        Task<CallResult<HitoBitResponse<HitoBitOrderOcoList>>> CancelOcoOrderAsync(string symbol, long? orderId = null, string? clientOrderId = null, string? newClientOrderId = null);
        /// <summary>
        ...
        /// <param name="newClientOrderId">New client order id for the order</param>
        /// <returns></returns>
        Task<CallResult<HitoBitResponse<HitoBitOrder>>> CancelOrderAsync(string symbol, int? orderId = null, string? clientOrderId = null, string? newClientOrderId = null);
        /// <summary>
        ...
        /// <param name="clientOrderId">Client order id</param>
        /// <returns></returns>
        Task<CallResult<HitoBitResponse<HitoBitOrderOcoList>>> GetOcoOrderAsync(long? orderId = null, string? clientOrderId = null);
        /// <summary>
        ...
        /// <returns></returns>
        Task<CallResult<HitoBitResponse<IEnumerable<HitoBitOrderOcoList>>>> GetOcoOrdersAsync(long? fromOrderId = null, DateTime? startTime = null, DateTime? endTime = null, int? limit = null);
        /// <summary>
        /// Get open Oco orders
        ...
        /// <returns></returns>
        Task<CallResult<HitoBitResponse<IEnumerable<HitoBitOrder>>>> GetOpenOrdersAsync(string? symbol = null);
        /// <summary>
        ...
        /// <param name="clientOrderId">Client order id</param>
        /// <returns></returns>
        Task<CallResult<HitoBitResponse<HitoBitOrder>>> GetOrderAsync(string symbol, int? orderId = null, string? clientOrderId = null);
        /// <summary>
        /// Get order history
        ...
        /// <param name="limit">Max results</param>
        /// <returns></returns>
        Task<CallResult<HitoBitResponse<IEnumerable<HitoBitOrder>>>> GetOrdersAsync(string symbol, long? fromOrderId = null, DateTime? startTime = null, DateTime? endTime = null, int? limit = null);
        /// <summary>
        ...
        /// <param name="limit">Max results</param>
        /// <returns></returns>
        Task<CallResult<HitoBitResponse<IEnumerable<HitoBitPreventedTrade>>>> GetPreventedTradesAsync(string symbol, long? preventedTradeId = null, long? orderId = null, long? fromPreventedTradeId = null, int? limit = null);
        /// <summary>
        ...
        /// <param name="limit">Max results</param>
        /// <returns></returns>
        Task<CallResult<HitoBitResponse<IEnumerable<HitoBitTrade>>>> GetUserTradesAsync(string symbol, long? orderId = null, long? fromOrderId = null, DateTime? startTime = null, DateTime? endTime = null, int? limit = null);
        ...
        Task<CallResult<HitoBitResponse<HitoBitPlacedOrder>>> PlaceOrderAsync(string symbol, OrderSide side, SpotOrderType type, decimal? quantity = null, decimal? quoteQuantity = null, string? newClientOrderId = null, decimal? price = null, TimeInForce? timeInForce = null, decimal? stopPrice = null, decimal? icebergQty = null, int? trailingDelta = null, int? strategyId = null, int? strategyType = null, SelfTradePreventionMode? selfTradePreventionMode = null);
        ...
        Task<CallResult<HitoBitResponse<HitoBitPlacedOrder>>> PlaceTestOrderAsync(string symbol, OrderSide side, SpotOrderType type, decimal? quantity = null, decimal? quoteQuantity = null, string? newClientOrderId = null, decimal? price = null, TimeInForce? timeInForce = null, decimal? stopPrice = null, decimal? icebergQty = null, int? trailingDelta = null, int? strategyId = null, int? strategyType = null, SelfTradePreventionMode? selfTradePreventionMode = null);
