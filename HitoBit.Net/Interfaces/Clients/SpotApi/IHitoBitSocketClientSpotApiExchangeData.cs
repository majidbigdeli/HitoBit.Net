...
namespace HitoBit.Net.Interfaces.Clients.SpotApi
{
    ...
    public interface IHitoBitSocketClientSpotApiExchangeData
    {
        ...
        /// </summary>
        /// <returns></returns>
        Task<CallResult<HitoBitResponse<object>>> PingAsync();
        ...
        /// </summary>
        /// <returns></returns>
        Task<CallResult<HitoBitResponse<DateTime>>> GetServerTimeAsync();
        ...
        /// <returns></returns>
        Task<CallResult<HitoBitResponse<HitoBitExchangeInfo>>> GetExchangeInfoAsync(IEnumerable<string>? symbols = null);
        ...
        /// <returns></returns>
        Task<CallResult<HitoBitResponse<IEnumerable<HitoBitStreamAggregatedTrade>>>> GetAggregatedTradeHistoryAsync(string symbol, long? fromId = null, DateTime? startTime = null, DateTime? endTime = null, int? limit = null);
        /// <summary>
        ...
        /// <returns></returns>
        Task<CallResult<HitoBitResponse<IEnumerable<HitoBitBookPrice>>>> GetBookTickersAsync(IEnumerable<string>? symbols = null);
        /// <summary>
        ...
        /// <param name="symbol">The symbol</param>
        /// <returns></returns>
        Task<CallResult<HitoBitResponse<HitoBitAveragePrice>>> GetCurrentAvgPriceAsync(string symbol);
        /// <summary>
        ...
        /// <param name="limit">Max results</param>
        /// <returns></returns>
        Task<CallResult<HitoBitResponse<IEnumerable<HitoBitSpotKline>>>> GetKlinesAsync(string symbol, KlineInterval interval, DateTime? startTime = null, DateTime? endTime = null, int? limit = null);
        /// <summary>
        ...
        /// <returns></returns>
        Task<CallResult<HitoBitResponse<HitoBitOrderBook>>> GetOrderBookAsync(string symbol, int? limit = null);
        /// <summary>
        ...
        /// <param name="limit">Max results</param>
        /// <returns></returns>
        Task<CallResult<HitoBitResponse<IEnumerable<HitoBitRecentTradeQuote>>>> GetRecentTradesAsync(string symbol, int? limit = null);
        /// <summary>
        ...
        /// <param name="symbols">Filter by symbols</param>
        /// <returns></returns>
        Task<CallResult<HitoBitResponse<IEnumerable<HitoBitRollingWindowTick>>>> GetRollingWindowTickersAsync(IEnumerable<string> symbols);
        /// <summary>
        ...
        /// <param name="symbols">Filter by symbols</param>
        /// <returns></returns>
        Task<CallResult<HitoBitResponse<IEnumerable<HitoBit24HPrice>>>> GetTickersAsync(IEnumerable<string>? symbols = null);
        /// <summary>
        /// Gets the historical trades for a symbol
        /// <para><a href="https://HitoBit-docs.github.io/apidocs/websocket_api/en/#historical-trades-market_data" /></para>
        /// </summary>
        /// <param name="symbol">The symbol</param>
        /// <param name="fromId">Filter by from trade id</param>
        /// <param name="limit">Max results</param>
        /// <returns></returns>
        Task<CallResult<HitoBitResponse<IEnumerable<HitoBitRecentTradeQuote>>>> GetTradeHistoryAsync(string symbol, long? fromId = null, int? limit = null);
        /// <summary>
        ...
        /// <param name="limit">Max results</param>
        /// <returns></returns>
        Task<CallResult<HitoBitResponse<IEnumerable<HitoBitSpotKline>>>> GetUIKlinesAsync(string symbol, KlineInterval interval, DateTime? startTime = null, DateTime? endTime = null, int? limit = null);
