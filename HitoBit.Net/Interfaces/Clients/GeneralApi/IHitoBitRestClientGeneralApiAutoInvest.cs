...
namespace HitoBit.Net.Interfaces.Clients.GeneralApi
{
    ...
    /// </summary>
    public interface IHitoBitRestClientGeneralApiAutoInvest
    {
        /// <summary>
        ...
        Task<WebCallResult<HitoBitAutoInvestAssets>> GetSourceAndTargetAssetsAsync(CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        Task<WebCallResult<HitoBitAutoInvestSourceAssets>> GetSourceAssetsAsync(string usageType, string? targetAsset = null, bool? flexibleAllowedToUse = null, string? sourceType = null, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<HitoBitAutoInvestTargetAssets>> GetTargetAssetsAsync(string? targetAsset = null, int? page = null, int? pageSize = null, CancellationToken ct = default);
        /// <summary>
        ...
        /// <param name="ct">Cancellation token</param>
        Task<WebCallResult<IEnumerable<HitoBitAutoInvestRoi>>> GetTargetAssetRoisAsync(string asset, AutoInvestRoiType roiType, CancellationToken ct = default);
        /// <summary>
        /// Get index info
        ...
        /// <param name="ct">Cancellation token</param>
        Task<WebCallResult<HitoBitAutoInvestIndex>> GetIndexInfoAsync(string indexId, CancellationToken ct = default);
        /// <summary>
        ...
        /// <param name="ct">Cancellation token</param>
        Task<WebCallResult<HitoBitAutoInvestPlan>> GetPlansAsync(AutoInvestPlanType planType, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        Task<WebCallResult<HitoBitAutoInvestTradeResult>> OneTimeTransactionAsync(string sourceType, string requestId, decimal subscriptionQuantity, string sourceAsset, bool flexibleAllowedToUse, long indexId, Dictionary<string, decimal> subscriptionDetails, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        Task<WebCallResult<HitoBitAutoInvestEditStatusResult>> EditPlanStatusAsync(long planId, AutoInvestPlanStatus status, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        Task<WebCallResult<HitoBitAutoInvestRedemptionResult>> RedeemIndexLinkedPlanAsync(string indexId, string requestId, int redemptionPercentage, CancellationToken ct = default);
        ...
        /// <param name="pageSize">Page size</param>
        /// <param name="ct">Cancellation token</param>
        Task<WebCallResult<HitoBitAutoInvestPlanTransactions>> GetSubscriptionTransactionHistoryAsync(long? planId = null, DateTime? startTime = null, DateTime? endTime = null, string? targetAsset = null, AutoInvestPlanType? planType = null, int? page = null, int? pageSize = null, CancellationToken ct = default);
        ...
        /// <param name="requestId">Request id</param>
        /// <param name="ct">Cancellation token</param>
        Task<WebCallResult<HitoBitAutoInvestOneTimeTransactionStatus>> GetOneTimeTransactionStatusAsync(long transactionId, string requestId, CancellationToken ct = default);
        ...
        /// <param name="asset">The asset, for example `ETH`</param>
        /// <param name="ct">Cancellation token</param>
        Task<WebCallResult<IEnumerable<HitoBitAutoInvestRedemption>>> GetIndexLinkedPlanRedemptionHistoryAsync(long requestId, DateTime? startTime = null, DateTime? endTime = null, int? page = null, int? pageSize = null, string? asset = null, CancellationToken ct = default);
        ...
        /// <param name="requestId">Request id</param>
        /// <param name="ct">Cancellation token</param>
        Task<WebCallResult<HitoBitAutoInvestPlanHoldings>> GetPlanHoldingsAsync(long? planId = null, string? requestId = null, CancellationToken ct = default);
        ...
        /// <param name="indexId">The index id</param>
        /// <param name="ct">Cancellation token</param>
        Task<WebCallResult<HitoBitAutoInvestIndexPlanPosition>> GetIndexLinkedPlanPositionDetailsAsync(long indexId, CancellationToken ct = default);
        ...
        /// <param name="pageSize">Page size</param>
        /// <param name="ct">Cancellation token</param>
        Task<WebCallResult<IEnumerable<HitoBitAutoInvestRebalanceInfo>>> GetIndexLinkedPlanRebalanceHistoryAsync(DateTime? startTime = null, DateTime? endTime = null, int? page = null, int? pageSize = null, CancellationToken ct = default);
