...
namespace HitoBit.Net.Interfaces.Clients.GeneralApi
{
    ...
    /// </summary>
    public interface IHitoBitRestClientGeneralApiMining
    {
        /// <summary>
        ...
        Task<WebCallResult<IEnumerable<HitoBitMiningCoin>>> GetMiningCoinListAsync(CancellationToken ct = default);
        ...
        Task<WebCallResult<IEnumerable<HitoBitMiningAlgorithm>>> GetMiningAlgorithmListAsync(CancellationToken ct = default);
        ...
        Task<WebCallResult<IEnumerable<HitoBitMinerDetails>>> GetMinerDetailsAsync(string algorithm, string userName, string workerName, CancellationToken ct = default);
        ...
        Task<WebCallResult<HitoBitMinerList>> GetMinerListAsync(string algorithm, string userName, int? page = null, bool? sortAscending = null, string? sortColumn = null, MinerStatus? workerStatus = null, CancellationToken ct = default);
        ...
        Task<WebCallResult<HitoBitRevenueList>> GetMiningRevenueListAsync(string algorithm, string userName, string? coin = null, DateTime? startDate = null, DateTime? endDate = null, int? page = null, int? pageSize = null, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>Revenue list</returns>
        Task<WebCallResult<HitoBitOtherRevenueList>> GetMiningOtherRevenueListAsync(string algorithm, string userName, string? coin = null, DateTime? startDate = null, DateTime? endDate = null, int? page = null, int? pageSize = null, CancellationToken ct = default);
        ...
        Task<WebCallResult<HitoBitMiningStatistic>> GetMiningStatisticsAsync(string algorithm, string userName, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>Revenue list</returns>
        Task<WebCallResult<IEnumerable<HitoBitMiningAccount>>> GetMiningAccountListAsync(string algorithm, string userName, CancellationToken ct = default);
        ...
        Task<WebCallResult<HitoBitHashrateResaleList>> GetHashrateResaleListAsync(int? page = null, int? pageSize = null, CancellationToken ct = default);
        ...
        Task<WebCallResult<HitoBitHashrateResaleDetails>> GetHashrateResaleDetailsAsync(int configId, string userName, int? page = null, int? pageSize = null, CancellationToken ct = default);
