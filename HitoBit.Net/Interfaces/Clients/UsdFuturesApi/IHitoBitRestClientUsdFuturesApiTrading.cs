...
namespace HitoBit.Net.Interfaces.Clients.UsdFuturesApi
{
    ...
    public interface IHitoBitRestClientUsdFuturesApiTrading
    {
        ...
        Task<WebCallResult<HitoBitFuturesPlacedOrder>> PlaceOrderAsync(
            string symbol,
            OrderSide side,
        ...
        Task<WebCallResult<IEnumerable<CallResult<HitoBitFuturesPlacedOrder>>>> PlaceMultipleOrdersAsync(
        ...
        Task<WebCallResult<HitoBitFuturesOrder>> GetOrderAsync(string symbol, long? orderId = null, string? origClientOrderId = null, long? receiveWindow = null, CancellationToken ct = default);
        ...
        Task<WebCallResult<HitoBitFuturesCancelOrder>> CancelOrderAsync(string symbol, long? orderId = null, string? origClientOrderId = null, long? receiveWindow = null, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>Id's for canceled order</returns>
        Task<WebCallResult<IEnumerable<CallResult<HitoBitFuturesCancelOrder>>>> CancelMultipleOrdersAsync(string symbol, List<long>? orderIdList = null, List<string>? origClientOrderIdList = null, long? receiveWindow = null, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>The specific order</returns>
        Task<WebCallResult<HitoBitFuturesOrder>> GetOpenOrderAsync(string symbol, long? orderId = null, string? origClientOrderId = null, long? receiveWindow = null, CancellationToken ct = default);
        ...
        Task<WebCallResult<IEnumerable<HitoBitFuturesOrder>>> GetOpenOrdersAsync(string? symbol = null, int? receiveWindow = null, CancellationToken ct = default);
        ...
        Task<WebCallResult<IEnumerable<HitoBitFuturesOrder>>> GetOrdersAsync(string symbol, long? orderId = null, DateTime? startTime = null, DateTime? endTime = null, int? limit = null, int? receiveWindow = null, CancellationToken ct = default);
        ...
        Task<WebCallResult<IEnumerable<HitoBitFuturesOrder>>> GetForcedOrdersAsync(string? symbol = null,
