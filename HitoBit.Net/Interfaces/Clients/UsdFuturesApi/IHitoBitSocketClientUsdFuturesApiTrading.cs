...
namespace HitoBit.Net.Interfaces.Clients.UsdFuturesApi
{
    ...
    /// </summary>
    public interface IHitoBitSocketClientUsdFuturesApiTrading
    {
        /// <summary>
        /// Place a new order
        ...
        Task<CallResult<HitoBitResponse<HitoBitUsdFuturesOrder>>> PlaceOrderAsync(string symbol,
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<CallResult<HitoBitResponse<HitoBitUsdFuturesOrder>>> EditOrderAsync(string symbol, OrderSide side, decimal quantity, decimal price, long? orderId = null, string? origClientOrderId = null, long? receiveWindow = null, CancellationToken ct = default);
        ...
        Task<CallResult<HitoBitResponse<HitoBitUsdFuturesOrder>>> CancelOrderAsync(string symbol, long? orderId = null, string? origClientOrderId = null, long? receiveWindow = null, CancellationToken ct = default);
        ...
        Task<CallResult<HitoBitResponse<HitoBitUsdFuturesOrder>>> GetOrderAsync(string symbol, long? orderId = null, string? origClientOrderId = null, long? receiveWindow = null, CancellationToken ct = default);
        ...
        /// <param name="receiveWindow">The receive window for which this request is active. When the request takes longer than this to complete the server will reject the request</param>
        /// <param name="ct">Cancellation token</param>
        Task<CallResult<HitoBitResponse<IEnumerable<HitoBitPositionV3>>>> GetPositionsAsync(string? symbol = null, long? receiveWindow = null, CancellationToken ct = default);
