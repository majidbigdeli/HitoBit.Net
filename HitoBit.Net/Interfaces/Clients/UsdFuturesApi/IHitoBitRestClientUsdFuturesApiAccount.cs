...
namespace HitoBit.Net.Interfaces.Clients.UsdFuturesApi
{
    ...
    /// </summary>
    public interface IHitoBitRestClientUsdFuturesApiAccount
    {
        /// <summary>
        ...
        Task<WebCallResult<IEnumerable<HitoBitPositionDetailsUsdt>>> GetPositionInformationAsync(string? symbol = null,
        ...
        Task<WebCallResult<IEnumerable<HitoBitFuturesIncomeHistory>>> GetIncomeHistoryAsync(string? symbol = null, string? incomeType = null, DateTime? startTime = null, DateTime? endTime = null, int? page = null, int? limit = null, long? receiveWindow = null, CancellationToken ct = default);
        ...
        Task<WebCallResult<IEnumerable<HitoBitFuturesSymbolBracket>>> GetBracketsAsync(string? symbol = null, long? receiveWindow = null, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<HitoBitFuturesAccountInfo>> GetAccountInfoV2Async(long? receiveWindow = null, CancellationToken ct = default);
        ...
        /// <param name="receiveWindow">The receive window for which this request is active. When the request takes longer than this to complete the server will reject the request</param>
        /// <param name="ct">Cancellation token</param>
        Task<WebCallResult<HitoBitFuturesAccountInfoV3>> GetAccountInfoV3Async(long? receiveWindow = null, CancellationToken ct = default);
        ...
        Task<WebCallResult<IEnumerable<HitoBitUsdFuturesAccountBalance>>> GetBalancesAsync(long? receiveWindow = null, CancellationToken ct = default);
        ...
        Task<WebCallResult<HitoBitFuturesMultiAssetMode>> GetMultiAssetsModeAsync(long? receiveWindow = null, CancellationToken ct = default);
        ...
        Task<WebCallResult<HitoBitResult>> SetMultiAssetsModeAsync(bool enabled, long? receiveWindow = null, CancellationToken ct = default);
        ...
        Task<WebCallResult<HitoBitFuturesTradingStatus>> GetTradingStatusAsync(int? receiveWindow = null, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<IEnumerable<HitoBitRateLimit>>> GetOrderRateLimitAsync(long? receiveWindow = null, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<HitoBitBnbBurnStatus>> GetBnbBurnStatusAsync(long? receiveWindow = null, CancellationToken ct = default);
        ...
        /// <param name="receiveWindow">The receive window for which this request is active. When the request takes longer than this to complete the server will reject the request</param>
        /// <param name="ct">Cancellation token</param>
        Task<WebCallResult<IEnumerable<HitoBitSymbolConfiguration>>> GetSymbolConfigurationAsync(string? symbol = null, long? receiveWindow = null, CancellationToken ct = default);
        ...
        /// <param name="receiveWindow">The receive window for which this request is active. When the request takes longer than this to complete the server will reject the request</param>
        /// <param name="ct">Cancellation token</param>
        Task<WebCallResult<HitoBitFuturesAccountConfiguration>> GetAccountConfigurationAsync(long? receiveWindow = null, CancellationToken ct = default);
