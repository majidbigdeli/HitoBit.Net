...
namespace HitoBit.Net.Interfaces.Clients.UsdFuturesApi
{
    ...
    /// </summary>
    public interface IHitoBitSocketClientUsdFuturesApiExchangeData
    {
        /// <summary>
        ...
        Task<CallResult<HitoBitResponse<HitoBitFuturesOrderBook>>> GetOrderBookAsync(string symbol, int? limit = null, CancellationToken ct = default);
        ...
        Task<CallResult<HitoBitResponse<HitoBitPrice>>> GetPriceAsync(string symbol, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>Price of symbol</returns>
        Task<CallResult<HitoBitResponse<IEnumerable<HitoBitPrice>>>> GetPricesAsync(CancellationToken ct = default);
        ...
        Task<CallResult<HitoBitResponse<HitoBitBookPrice>>> GetBookPriceAsync(string symbol, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>List of book prices</returns>
        Task<CallResult<HitoBitResponse<IEnumerable<HitoBitBookPrice>>>> GetBookPricesAsync(CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token for closing this subscription</param>
        /// <returns>A stream subscription. This stream subscription can be used to be notified when the socket is disconnected/reconnected</returns>
        Task<CallResult<UpdateSubscription>> SubscribeToMarkPriceUpdatesAsync(string symbol, int? updateInterval, Action<DataEvent<HitoBitFuturesUsdtStreamMarkPrice>> onMessage, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token for closing this subscription</param>
        /// <returns>A stream subscription. This stream subscription can be used to be notified when the socket is disconnected/reconnected</returns>
        Task<CallResult<UpdateSubscription>> SubscribeToMarkPriceUpdatesAsync(IEnumerable<string> symbols, int? updateInterval, Action<DataEvent<HitoBitFuturesUsdtStreamMarkPrice>> onMessage, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token for closing this subscription</param>
        /// <returns>A stream subscription. This stream subscription can be used to be notified when the socket is disconnected/reconnected</returns>
        Task<CallResult<UpdateSubscription>> SubscribeToContinuousContractKlineUpdatesAsync(string pair, ContractType contractType, KlineInterval interval, Action<DataEvent<HitoBitStreamContinuousKlineData>> onMessage, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token for closing this subscription</param>
        /// <returns>A stream subscription. This stream subscription can be used to be notified when the socket is disconnected/reconnected</returns>
        Task<CallResult<UpdateSubscription>> SubscribeToContinuousContractKlineUpdatesAsync(IEnumerable<string> pairs, ContractType contractType, KlineInterval interval, Action<DataEvent<HitoBitStreamContinuousKlineData>> onMessage, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token for closing this subscription</param>
        /// <returns>A stream subscription. This stream subscription can be used to be notified when the socket is disconnected/reconnected</returns>
        Task<CallResult<UpdateSubscription>> SubscribeToAllMarkPriceUpdatesAsync(int? updateInterval, Action<DataEvent<IEnumerable<HitoBitFuturesUsdtStreamMarkPrice>>> onMessage, CancellationToken ct = default);
