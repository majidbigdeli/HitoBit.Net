...
namespace HitoBit.Net.Interfaces.Clients.CoinFuturesApi
{
    ...
    /// </summary>
    public interface IHitoBitRestClientCoinFuturesApiTrading
    {
        /// <summary>
        /// Places a new order
        ...
        Task<WebCallResult<IEnumerable<HitoBitFuturesOrder>>> GetOrdersAsync(string? symbol = null, long? orderId = null, DateTime? startTime = null, DateTime? endTime = null, int? limit = null, int? receiveWindow = null, CancellationToken ct = default);
        ...
        Task<WebCallResult<IEnumerable<HitoBitFuturesCoinTrade>>> GetUserTradesAsync(string? symbol = null, string? pair = null, DateTime? startTime = null, DateTime? endTime = null, int? limit = null, long? fromId = null, long? orderId = null, long? receiveWindow = null, CancellationToken ct = default);
    }
}
