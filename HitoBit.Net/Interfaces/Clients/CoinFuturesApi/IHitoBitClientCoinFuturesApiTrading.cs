...
namespace HitoBit.Net.Interfaces.Clients.CoinFuturesApi
{
    ...
    /// </summary>
    public interface IHitoBitClientCoinFuturesApiTrading
    {
        /// <summary>
        /// Places a new order
        ...
        Task<WebCallResult<IEnumerable<HitoBitFuturesCoinTrade>>> GetUserTradesAsync(string? symbol = null, string? pair = null, DateTime? startTime = null, DateTime? endTime = null, int? limit = null, long? fromId = null, long? receiveWindow = null, CancellationToken ct = default);
    }
}
