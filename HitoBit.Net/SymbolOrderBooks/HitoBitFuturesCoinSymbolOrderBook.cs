...
namespace HitoBit.Net.SymbolOrderBooks
{
    ...
    /// </summary>
    public class HitoBitFuturesCoinSymbolOrderBook : SymbolOrderBook
    {
        ...
        public HitoBitFuturesCoinSymbolOrderBook(string symbol, HitoBitOrderBookOptions? options = null) : base("HitoBit", symbol, options ?? new HitoBitOrderBookOptions())
        {
